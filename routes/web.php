...
Route::put('/edit_product_submit', [ProductController::class, 'edit_product_submit'])->name('edit_product_submit')->middleware(CheckLogin::class);

Route::get('/delete_product/{id}', [ProductController::class, 'delete_product'])->name('delete_product')->middleware(CheckLogin::class);
Route::delete('/delete_product_confirm/{id}', [ProductController::class, 'delete_product_confirm'])->name('delete_product_confirm')->middleware(CheckLogin::class);