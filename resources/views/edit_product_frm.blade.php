                ...
                <form action="{{ route('edit_product_submit') }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="text_product_name" id="text_product_name" class="form-control"
                            placeholder="Nome do produto" required value="{{ old('text_product_name', $product->product_name) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="text_product_description" id="text_product_description" class="form-control" placeholder="Digite a descrição do produto..." rows="5">{{ old('text_product_description', $product->product_description) }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="text_product_price" id="text_product_price" class="form-control"
                            ...
                            value="{{ old('text_product_price', $product->product_price) }}">
